...
const CATEGORIA_I18N_KEYS={Mercado:'category.market',Transporte:'category.transport',Lazer:'category.leisure','Saúde':'category.health',Casa:'category.home',Assinaturas:'category.subscriptions',Outros:'category.other'};
