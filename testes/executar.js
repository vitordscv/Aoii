...
const arquivos=['motor.test.js','entrada.test.js','datas.test.js','listas.test.js','i18n.test.js',
                'dividas.test.js','fixo-pago.test.js','validacao.test.js','juros.test.js','ferramentas.test.js','cripto.test.js','nuvem.test.js','ciclo-sync.test.js','conflito-real.test.js','sync-queue.test.js'];
